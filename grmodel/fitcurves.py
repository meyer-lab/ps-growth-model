...
def fitcurves(dfdict):
    ...
    for key in dfdict.keys():
        ...
        for row in table.iterrows():
            ...
            res_1 = sp.optimize.least_squares(residuals, p_guess,
                                              bounds=(mins, maxs), args=(x, y))
            # Save solution
...
def plotcurves(drugs, params, log=False):
    ...
    curveparamsdict = fitcurves(dfdict)

    # Initialize subplots
    _, axis = plt.subplots(len(drugs), len(params), figsize=(10, 2.5*len(drugs)),
